...
class Draw {
    ...
    scores(left_player_score, right_player_score) {
        this.text(left_player_score, canvas.width / 4, canvas.height / 5, 'RED', '75px Serif');
        this.text(right_player_score, (canvas.width / 4) * 3, canvas.height / 5, 'RED', '75px Serif');
    }
...
class Pong {
    ...
    moveRightPlayer() {
        ...
        return ((this.ball.y - (this.right_player.y + this.player_height / 2)) *
            this.computer_level);
    }
    resetBall() {
    ...
    updateBallLocation() {
        ...
        const player = this.ball.x < canvas.width / 2 ? this.left_player : this.right_player;
        // Check for pad collision and change ball direction
        if (this.collision(player)) {
            const collidePoint = (this.ball.y - (player.y + this.player_height / 2)) /
    ...
    render() {
        ...
        // Draw scores
        this.draw.scores(this.right_player.score.toString(), this.left_player.score.toString());
        // this.draw.score(
        // (canvas.width / 4) * 3,
        // canvas.height / 5,
        // 'RED',
        ...
        // Draw left player
        this.draw.pads(this.left_player.x, this.left_player.y, this.player_width, this.player_height, this.player_color);
        // Draw right player
        this.draw.pads(this.right_player.x, this.right_player.y, this.player_width, this.player_height, this.player_color);
        // Draw ball
